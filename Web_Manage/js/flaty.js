$(function () {
    ...
    var scrollableSidebar = function (doScroll) {
        ...
        $('#sidebar.sidebar-fixed .nav').css('height', winHeight + 'px').niceScroll({
            railalign: 'left',
            railoffset: {left: 3},
    ...
    $('#sidebar-collapse').click(function () {
        ...
        if ($('#sidebar').hasClass('sidebar-collapsed')) {
            ...
            $.cookie('sidebar-collapsed', 'true', cookie_conf);
        } else {
            $('#sidebar-collapse > i').attr('class', 'icon-double-angle-left');
            $.cookie('sidebar-collapsed', 'false', cookie_conf);
        }
    ...
    $('#theme-setting ul.colors a').click(function () {
        ...
        $.cookie(prefix + 'color', color, cookie_conf);
    });
    ...
    $('.box .box-tool > a').click(function (e) {
        ...
        switch (action) {
            ...
            case 'config':
                ...
                break;
            case 'show':
                $(this).closest(".box").find(".table tbody .over").show();
        }
        setTimeout(function () {
            resizeNicescroll();
        }, 600);
    ...
    //----------------------- Chosen Select ---------------------//
    if (jQuery().chosen) {
        $(".chosen").chosen({no_results_text: "查無資料"});
