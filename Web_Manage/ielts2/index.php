...
$col[] = array('column' => 'email', 'name' => 'email', 'order' => true);

$col[] = array('column' => 'a1', 'name' => 'Q1', 'order' => true, 'width' => '80');
$col[] = array('column' => 'a2', 'name' => 'Q2', 'order' => true, 'width' => '80');
$col[] = array('column' => 'a3', 'name' => 'Q3', 'order' => true, 'width' => '80');
$col[] = array('column' => 'a4', 'name' => 'Q4', 'order' => true, 'width' => '80');
$col[] = array('column' => 'a5', 'name' => 'Q4', 'order' => true, 'width' => '80');
$col[] = array('column' => 'result', 'name' => '測驗結果', 'order' => true);
$col[] = array('column' => 'shared', 'name' => '是否分享', 'order' => true);
        ...
        $('#table1').coderlisthelp({
            debug: true, callback: function (obj, rows) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    $tr.append('<td>' + row["a1"] + '</td>');
                    $tr.append('<td>' + row["a2"] + '</td>');
                    $tr.append('<td>' + row["a3"] + '</td>');
                    $tr.append('<td>' + row["a4"] + '</td>');
                    $tr.append('<td>' + row["a5"] + '</td>');
                    $tr.append('<td>' + row["result"] + '</td>');
                    $tr.append('<td>' + row["shared"] + '</td>');
