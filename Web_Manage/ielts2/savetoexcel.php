...
try{
    ...
    $sheet->setCellValue($cd_kn[$cd_ki].$index,'a1');$cd_ki++;
    $sheet->setCellValue($cd_kn[$cd_ki].$index,'a2');$cd_ki++;
    $sheet->setCellValue($cd_kn[$cd_ki].$index,'a3');$cd_ki++;
    $sheet->setCellValue($cd_kn[$cd_ki].$index,'a4');$cd_ki++;
    $sheet->setCellValue($cd_kn[$cd_ki].$index,'a5');$cd_ki++;
    $sheet->setCellValue($cd_kn[$cd_ki].$index,'測驗結果');$cd_ki++;
    ...
    if($rows){
        ...
        foreach ($rows as $key => $row) {
            ...
            $sheet->setCellValueExplicit($cd_kn[$cd_ki].$index,$row['a1'],PHPExcel_Cell_DataType::TYPE_STRING);$cd_ki++;
            $sheet->setCellValueExplicit($cd_kn[$cd_ki].$index,$row['a2'],PHPExcel_Cell_DataType::TYPE_STRING);$cd_ki++;
            $sheet->setCellValueExplicit($cd_kn[$cd_ki].$index,$row['a3'],PHPExcel_Cell_DataType::TYPE_STRING);$cd_ki++;
            $sheet->setCellValueExplicit($cd_kn[$cd_ki].$index,$row['a4'],PHPExcel_Cell_DataType::TYPE_STRING);$cd_ki++;
            $sheet->setCellValueExplicit($cd_kn[$cd_ki].$index,$row['a5'],PHPExcel_Cell_DataType::TYPE_STRING);$cd_ki++;
