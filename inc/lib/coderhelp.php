...
class coderHelp
{
	...
	//製作陣列中屬性與KEY值的對照,ex $ary['a']['$_key']=1,$ary['b']['$_key']=2 => array('a'=>1,b=>'2')
	public static function makeAryKeyValue2($array,$_key)
	{
		$ary=array();
		foreach($array as $key=>$item)
		{
    ...
    public static function getPageInfo($page, $totalrows, $show_num = 10, $num_page = 10, $page_style=''){
        if ((int)$totalrows > 0) {
